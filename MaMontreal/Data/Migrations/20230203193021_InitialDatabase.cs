        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SobrietyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleRequestedId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RoleRequestedId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRequests_AspNetUsers_RequestHandlerId",
                        column: x => x.RequestHandlerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserRequests_AspNetUsers_RequesteeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GsrId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meetings_AspNetUsers_GsrId",
                        column: x => x.GsrId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Meetings_Languages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meetings_GsrId",
                table: "Meetings",
                column: "GsrId");

            migrationBuilder.CreateIndex(
                name: "IX_Meetings_LanguageId",
                table: "Meetings",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRequests_RequesteeId",
                table: "UserRequests",
                column: "RequesteeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRequests_RequestHandlerId",
                table: "UserRequests",
                column: "RequestHandlerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRequests_RoleRequestedId",
                table: "UserRequests",
